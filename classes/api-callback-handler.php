...
class Latitude_Checkout_API_Callbacks
{
    ...
    public function on_cancel_purchase()
    {
        ...
        if (array_key_exists('cancel_order', $_GET) && array_key_exists('order_id', $_GET) && $_GET['cancel_order'] === 'true' && isset( $_GET['_wpnonce'] ) && wp_verify_nonce( wp_unslash( $_GET['_wpnonce'] ), 'woocommerce-cancel_order' ) ) {
